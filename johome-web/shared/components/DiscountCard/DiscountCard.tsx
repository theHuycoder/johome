        ...
        <Card expanded={expanded}>
          ...
          <CardContent flexShrink={0} expanded={expanded}>
            ...
            <PriceBox textAlign="center">
              {!expanded && <Title textAlign="center">{title}</Title>}
              <OriginalPrice textAlign={!expanded ? "center" : "left"}>{formatPrice(originalPrice)}</OriginalPrice>
              <SalePrice textAlign={!expanded ? "center" : "left"}>{formatPrice(salePrice)}</SalePrice>
            </PriceBox>
            {!!expanded && (
              <Box>
                <Countdown
